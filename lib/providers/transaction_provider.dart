...
class TransactionProvider extends ChangeNotifier {
  ...
  void loadDummyData() {
    ...
    _transactions = [
      ...
      // Additional transactions spread over 3 months (35-90 days ago)
      Transaction(
        id: 'guest_19',
        plaidId: 'plaid_guest_19',
        name: 'Home Depot',
      ...
      Transaction(
        id: 'guest_26',
        plaidId: 'plaid_guest_26',
        name: 'AMC Theaters',
        merchantName: 'AMC Theatres',
        amount: 42.00,
        date: now.subtract(const Duration(days: 79)),
        isCategorized: false,
      ),
      Transaction(
        id: 'guest_27',
        plaidId: 'plaid_guest_27',
        name: 'Lowe\'s',
        merchantName: 'Lowe\'s',
        amount: 89.99,
